# This application will read an iTunes export
# file in XML and produce a properly normalized database with this structure:
...
# Library.xml file to be used for this assignment. You can export your own
# tracks from iTunes and create a database, but for the database that you turn
# in for this assignment, only use the Library.xml data that is provided.
...
conn = sqlite3.connect('trackdatab.sqlite')
cur = conn.cursor()
...
if ( len(fname) < 1 ) : fname = 'Libraryass.xml'
